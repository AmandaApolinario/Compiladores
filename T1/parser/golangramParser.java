...
public class golangramParser extends Parser {
	...
	public static final int
		...
		AMPERSAND=39, OR=40, PLUSONE=41, MINUSONE=42, ISEQUAL=43, LESSTHAN=44, 
		MORETHAN=45, ASSIGN=46, NOT=47, NOTEQUAL=48, LESSEQTHAN=49, MOREEQTHAN=50, 
		DECLARE_ASSIGN=51, LPAR=52, RPAR=53, LBRACK=54, RBRACK=55, LCURLYBRACES=56, 
		RCURLYBRACES=57, COMMA=58, SEMI=59, COLON=60, ID=61, REAL_VAL=62, INT_VAL=63, 
		STR_VAL=64, COMMENT=65, BLOCK_COMMENT=66, WHITESPACE=67, UNKNOWN=68, EOS=69;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"MOD", "PLUSEQ", "MINUSEQ", "TIMESEQ", "OVEREQ", "MODEQ", "AND", "AMPERSAND", 
			"OR", "PLUSONE", "MINUSONE", "ISEQUAL", "LESSTHAN", "MORETHAN", "ASSIGN", 
			"NOT", "NOTEQUAL", "LESSEQTHAN", "MOREEQTHAN", "DECLARE_ASSIGN", "LPAR", 
			"RPAR", "LBRACK", "RBRACK", "LCURLYBRACES", "RCURLYBRACES", "COMMA", 
			"SEMI", "COLON", "ID", "REAL_VAL", "INT_VAL", "STR_VAL", "COMMENT", "BLOCK_COMMENT", 
	...
	public final FunctionDeclContext functionDecl() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 2328361007350554624L) != 0) {
				{
				setState(120);
				type_();
				}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la - 1)) & ~0x3f) == 0 && ((1L << (_la - 1)) & -826339885884338407L) != 0) {
				{
				setState(220);
				statementList();
				}
	...
	public final StatementListContext statementList() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la - 1)) & ~0x3f) == 0 && ((1L << (_la - 1)) & -826339885884338407L) != 0 );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Assign_opContext assign_op() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 1107833126912L) != 0) {
				{
				setState(272);
				_la = _input.LA(1);
				if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 1107833126912L) != 0) ) {
	...
	public final ForStmtContext forStmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la - 9)) & ~0x3f) == 0 && ((1L << (_la - 9)) & 67563066463092739L) != 0) {
					{
					setState(328);
					expression(0);
					}
			...
			case 3:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la - 9)) & ~0x3f) == 0 && ((1L << (_la - 9)) & 67563066463096835L) != 0) {
					{
					setState(332);
					rangeClause();
					}
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				_la = _input.LA(1);
				if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 140741514887168L) != 0) ) {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 2:
						...
						_la = _input.LA(1);
						if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 1100316934144L) != 0) ) {
					...
					case 3:
						...
						_la = _input.LA(1);
						if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 2031897488130048L) != 0) ) {
	...
	public static class OperandIDContext extends OperandContext {
		public TerminalNode ID() { return getToken(golangramParser.ID, 0); }
		public List<TerminalNode> AMPERSAND() { return getTokens(golangramParser.AMPERSAND); }
		public TerminalNode AMPERSAND(int i) {
			return getToken(golangramParser.AMPERSAND, i);
		}
	...
	public static final String _serializedATN =
		...
		".\f.\u01cc\t.\u0001.\u0001.\u0001.\u0001.\u0001.\u0003.\u01d3\b.\u0001"+
		"/\u0001/\u0001/\u0001/\u0003/\u01d9\b/\u00010\u00010\u00010\u00010\u0001"+
		"1\u00011\u00012\u00012\u00012\u00012\u00032\u01e5\b2\u00012\u00032\u01e8"+
		"\b2\u00032\u01ea\b2\u00012\u00012\u00013\u00013\u00013\u0000\u0002RT4"+
		"\u0000\u0002\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018\u001a"+
