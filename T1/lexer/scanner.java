...
public class scanner extends Lexer {
	...
	public static final int
		...
		MINUSONE=39, ISEQUAL=40, LESSTHAN=41, MORETHAN=42, EQUAL=43, NOT=44, NOTEQUAL=45, 
		LESSEQTHAN=46, MOREEQTHAN=47, ASSIGN=48, LPAR=49, RPAR=50, LBRACK=51, 
		RBRACK=52, LCURLYBRACES=53, RCURLYBRACES=54, COMMA=55, DOT=56, SEMI=57, 
		COLON=58, REAL_VAL=59, INT_VAL=60, STR_VAL=61, WHITESPACE=62, COMMENT=63, 
		UNKNOWN=64;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"LESSTHAN", "MORETHAN", "EQUAL", "NOT", "NOTEQUAL", "LESSEQTHAN", "MOREEQTHAN", 
			"ASSIGN", "LPAR", "RPAR", "LBRACK", "RBRACK", "LCURLYBRACES", "RCURLYBRACES", 
			"COMMA", "DOT", "SEMI", "COLON", "REAL_VAL", "INT_VAL", "STR_VAL", "WHITESPACE", 
			"COMMENT", "UNKNOWN"
		};
	}
